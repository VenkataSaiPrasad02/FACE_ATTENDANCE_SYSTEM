...
export const PERMISSIONS = {
  ...
  OPEN_ATTENDANCE_SESSION: 'OPEN_ATTENDANCE_SESSION',
  ...
  MANAGE_AUTO_FILL: 'MANAGE_AUTO_FILL',
...
const ADMIN_PERMISSIONS = [
  ...
  PERMISSIONS.OPEN_ATTENDANCE_SESSION,
...
export const ROLE_PERMISSIONS = {
  ...
  /*
   * Students are strictly restricted: own dashboard, own attendance
   * via teacher-opened sessions, own history, and profile/password.
   * The backend enforces the same boundary — this only hides UI.
   */
  [ROLES.STUDENT]: [
    PERMISSIONS.VIEW_DASHBOARD,
