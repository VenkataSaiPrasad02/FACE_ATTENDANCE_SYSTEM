...
export default function LoginPage() {
  ...
  // Info banner set by flows like the forced password change.
        ...
        >
          ...
          <div className="w-full max-w-md animate-slide-up">
            ...
            <div className="login-card rounded-3xl p-7 sm:p-9">
              ...
              {infoMessage && (
                <div className="mb-4 flex items-start gap-2.5 rounded-xl border border-cyan-300/25 bg-cyan-400/10 p-3 text-cyan-300 shadow-card animate-fade-in">
