  ...
  const submit = async (event) => {
    ...
    try {
      ...
      if (mustChangePassword) {
        /*
         * First-login flow: the old session token only permits this
         * page. Force a fresh login with the new credentials.
         */
        ...
        navigate('/login', {
          replace: true,
          state: {
            info: 'Password updated successfully. Please login with your new password.',
          },
        });
        return;
      }
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-400">
              {mustChangePassword
                ? 'For security, please replace your initial password before continuing.'
      ...
      {success && <SuccessBox message={success} />}
        ...
        <form onSubmit={submit} className="space-y-4">
          <PasswordField
            ...
            placeholder={mustChangePassword ? 'Enter the initial password' : 'Enter current password'}
          />
