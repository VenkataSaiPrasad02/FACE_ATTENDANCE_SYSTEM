...
const attendanceService = {
  ...
  /**
   * Manual marking by teacher/admin/super-admin with audit trail
   * (method=MANUAL, markedBy recorded server-side).
   */
  markManual: ({ studentId, date }) =>
    api.post('/api/attendance/manual', { studentId, date }).then((r) => r.data),
