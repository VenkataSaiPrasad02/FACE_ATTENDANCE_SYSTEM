...
var RESIZE_EMIT_DEBOUNCE_TIME = 250;
var MIN_ZOOM = 1;
var MAX_ZOOM = 3;
var KEYBOARD_STEP = 1;
var Cropper = class Cropper2 extends React.Component {
  constructor(..._args) {
    super(..._args);
    ...
    this.onWheel = (e) => {
      ...
      e.preventDefault();
      const point = Cropper2.getMousePoint(e);
      const { pixelY } = (0, import_normalize_wheel.default)(e);
  ...
  render() {
    ...
    return React.createElement("div", {
    ...
    }, image ? React.createElement("img", _objectSpread2(_objectSpread2({
      alt: "",
    ...
    })) : video && React.createElement("video", _objectSpread2(_objectSpread2({
      autoPlay: true,
      playsInline: true,
      loop: true,
      muted: true,
      ...
      style: _objectSpread2(_objectSpread2({}, mediaStyle), {}, { transform: transform || `translate(${x}px, ${y}px) rotate(${rotation}deg) scale(${zoom})` }),
      controls: false
    }), (Array.isArray(video) ? video : [{ src: video }]).map((item) => React.createElement("source", _objectSpread2({ key: item.src }, item)))), this.state.cropSize && React.createElement("div", _objectSpread2({
      ref: this.cropperRef,
